---
name: kiu-mao-anthology-no-investigation-no-decision
description: Use this KiU-generated action skill from Mao Anthology when the task matches `no-investigation-no-decision`.
---
...
## Identity
```yaml
skill_id: no-investigation-no-decision
...
## Rationale
`No Investigation No Decision` is a borrowed-value judgment skill anchored in "主观主义，在某些党员中浓厚地存在，这对分析政治形势和指导工作，都非常不利。因为对于政治形势的主观主义的分析和对于工作的主观主义的指导，其必然的结果，不是机会主义，就是盲动主义。至于党内的主观主义的批评，不要证据的乱说，或互相猜忌，往往酿成党内的无原则纠纷，破坏党的组织。 关于党内批评问题，还有一点要说及的，就是有些同志的批评不注意大的方面，只注意小的方面。他们不明白批评的主要任务，是指出政治上的错误和组织上的错误。至于个人缺点，如果不是"[^anchor:no-investigation-no-decision-situation-strategy::no-investigation-no-decision]. It should fire when the user is about to decide from reports, templates, book claims, or past experience without field evidence. The skill must not summarize, translate, introduce a person, answer a pure fact lookup, or comment on the author's stance as its main job; those remain source/retrieval tasks. Instead it maps the source pattern `investigation-before-judgment strategy` into a current decision only after checking transfer_conditions and anti_conditions. `主观主义，在某些党员中浓厚地存在，这对分析政治形势和指导工作，都非常不利。因为对于政治形势的主观主义的分析和对于工作的主观主义的指导，其必...` adds operational context through "主观主义，在某些党员中浓厚地存在，这对分析政治形势和指导工作，都非常不利。因为对于政治形势的主观主义的分析和对于工作的主观主义的指导，其必然的结果，不是机会主义，就是盲动主义。至于党内的主观主义的批评，不要证据的乱说，或互相猜忌，往往酿成党内的无原则纠纷，破坏党的组织。 关于党内批评问题，还有一点要说及的，就是有些同志的批评不注意大的方面，只注意小的方面。他们不明白批评的主要任务，是指出政治上的错误和组织上的错误。至于个人缺点，如果不是"[^anchor:no-investigation-no-decision-evidence::mao-0051]. `在对于时局的估量和伴随而来的我们的行动问题上，我们党内有一部分同志还缺少正确的认识。他们虽然相信革命高潮不可避免地要到来，却不相信革命高潮...` adds operational context through "在对于时局的估量和伴随而来的我们的行动问题上，我们党内有一部分同志还缺少正确的认识。他们虽然相信革命高潮不可避免地要到来，却不相信革命高潮有迅速到来的可能。因此他们不赞成争取江西的计划，而只赞成在福建、广东、江西之间的三个边界区域的流动游击，同时也没有在游击区域建立红色政权的深刻的观念，因此也就没有用这种红色政权的巩固和扩大去促进全国革命高潮的深刻的观念。他们似乎认为在距离革命高潮尚远的时期做这种建立政权的艰苦工作为徒劳，而希望用比较轻"[^anchor:no-investigation-no-decision-evidence::mao-0057]. The output must use `go_investigate / partial_judgment / do_not_decide` and include investigation_questions, transfer_conditions, anti_conditions, abuse_check, and field_evidence_next_action. It must explicitly detect `single_case_overreach` or `context_transfer_abuse` when the user tries to copy a book, historical case, competitor, large-company process, or past success without context fit.
...
The graph/source layer may extract summaries, chronology, facts, biography cues, positions, and source text broadly, but this skill consumes that evidence only for current decision transfer. Required transfer_conditions: current_decision_is_explicit, field_evidence_can_change_the_decision, investigation_questions_are_actionable_before_commitment. Blocking anti_conditions: context_transfer_abuse, pure_author_position_query, decision_window_already_closed. Pure summary, translation, fact lookup, biography introduction, author-position query, and stance commentary without user decision should not trigger the judgment skill.

Scenario-family anchor coverage: `should_trigger` `borrow-source-pattern-for-live-decision` -> `no-investigation-no-decision-situation-strategy::no-investigation-no-decision`, `no-investigation-no-decision-evidence::mao-0051` (There is a live current_decision and the user needs transferable judgment, not source explanation.); `should_not_trigger` `source-understanding-only` -> `no-investigation-no-decision-situation-strategy::no-investigation-no-decision`, `no-investigation-no-decision-evidence::mao-0051` (These are source/retrieval/QA tasks. The graph layer may extract them, but the judgment skill should not answer them as if they were transfer decisions.); `edge_case` `partial-transfer-with-material-differences` -> `no-investigation-no-decision-situation-strategy::no-investigation-no-decision`, `no-investigation-no-decision-evidence::mao-0051` (Borrow the mechanism only after naming both fit and non-fit conditions.); `refusal` `context-transfer-abuse` -> `no-investigation-no-decision-situation-strategy::no-investigation-no-decision`, `no-investigation-no-decision-evidence::mao-0051` (This is context_transfer_abuse: source material is being used as permission to bypass current-context judgment.); `refusal` `single-case-overreach` -> `no-investigation-no-decision-situation-strategy::no-investigation-no-decision`, `no-investigation-no-decision-evidence::mao-0051` (This is single_case_overreach: one case cannot carry a transferable decision without mechanism and counterexample checks.).
...
- Use this skill when the user is about to decide from reports, templates, book claims, or past experience without field evidence; the live current_decision must be explicit before the source pattern is transferred.
...
- Positive trigger signals include: 没有现场事实, 只看报告要拍板, 照搬过去经验, 先决定再补材料.
- Negative trigger signals include: 作者原话是什么, 总结这篇文章, 人物介绍, 评价立场但没有我的决策.
- Output investigation_questions, transfer_conditions, anti_conditions, abuse_check, and field_evidence_next_action with a `go_investigate / partial_judgment / do_not_decide` verdict.

Scenario families:
- `should_trigger` `borrow-source-pattern-for-live-decision`; No Investigation No Decision fires when the user is about to decide from reports, templates, book claims, or past experience without field evidence.; signals: 没有现场事实 / 只看报告要拍板 / 照搬过去经验; boundary: There is a live current_decision and the user needs transferable judgment, not source explanation.; next: Return investigation_questions, transfer_conditions, anti_conditions, abuse_check, and field_evidence_next_action with verdict go_investigate / partial_judgment / do_not_decide.
- `should_not_trigger` `source-understanding-only`; Do not fire when the user only asks for summary, translation, fact lookup, biography introduction, author-position query, or stance commentary without a current decision.; signals: 作者原话是什么 / 总结这篇文章 / 人物介绍; boundary: These are source/retrieval/QA tasks. The graph layer may extract them, but the judgment skill should not answer them as if they were transfer decisions.
...
- `traces/canonical/no-investigation-no-decision-source-smoke.yaml`
