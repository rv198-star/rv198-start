---
name: kiu-poor-charlie-bias-self-audit
description: Use this KiU-generated action skill from Poor Charlie's Almanack when the task matches `bias-self-audit`.
---
