---
name: kiu-poor-charlie-invert-the-problem
description: Use this KiU-generated action skill from Poor Charlie's Almanack when the task matches `invert-the-problem`.
---
