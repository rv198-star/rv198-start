---
name: kiu-poor-charlie-value-assessment-source-note
description: Use this KiU-generated action skill from Poor Charlie's Almanack when the task matches `value-assessment-source-note`.
---
